...
\CTEXsetup[format={\centering\bfseries\zihao{-2}},name={第, 部分},number={\chinese{section}}]{section}
%修改章节的标题样式，包括章节的序号是中文，格式等等
\CTEXsetup[nameformat={\bfseries\zihao{3}},name={第, 章}]{subsection}
...
\include{body/chapter12}
\include{body/chapter13}
\include{body/chapter14}
%============= 参考文献 =====================
